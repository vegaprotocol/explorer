...
<nav>
  <ul>
    ...
    <li>
      <a
        aria-current={segment === "network" ? "page" : undefined}
        href="network">network</a
      >
    </li>
    <li>
      <a
        aria-current={segment === "trading" ? "page" : undefined}
        href="trading">trading</a
      >
    </li>
    <li>
    ...
    <li>
      <a aria-current={segment === "party" ? "page" : undefined} href="party"
        >party</a
      >
    </li>
    <li>
